(function ($) {
  ...
  $(".navbar-nav li a").on("click", function (e) {
    ...
    $("html, body")
      .stop()
      .animate({ scrollTop: $(anchor.attr("href")).offset().top - 10 }, 30);
    e.preventDefault();
  });
  ...
  $(".how-use-slider").owlCarousel({
    ...
    center: true,
    smartSpeed: 2000,
    responsive: { 0: { items: 1 }, 600: { items: 3 }, 992: { items: 1 } },
  });
  $(".testimonial-slider").owlCarousel({
    ...
    items: 1,
    smartSpeed: 2000,
    responsive: { 0: { items: 1 }, 600: { items: 2 }, 992: { items: 1 } },
  });
...
function setTheme(themeName) {
  localStorage.setItem("landset_theme", themeName);
  document.documentElement.className = themeName;
}
function toggleTheme() {
  if (localStorage.getItem("landset_theme") === "theme-dark") {
